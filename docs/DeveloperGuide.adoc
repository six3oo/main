...
To tackle this problem, the `formatNumber` method is implemented to reduce the number of digits to 1 decimal place with the order of magnitude suffix placed behind the number. The result can be seen in the views categories in Figure 3.5.2.1 below.
