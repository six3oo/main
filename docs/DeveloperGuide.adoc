...
==== Profile GUI
Displayed at the top are the dynamic information about the channel, that the contact is affiliated with, as stated above. Displayed at the bottom would be the static information of the individual contact.
