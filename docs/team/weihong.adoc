...
* Wrote additional tests to increase coverage (+1.1%) to 82.359% (Pull requests https://github.com/CS2103AUG2017-T15-B1/main/pull/117[#117], https://github.com/CS2103AUG2017-T15-B1/main/pull/138[#138])
